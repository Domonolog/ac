...
jQuery(function ($) {
  ...
  $('.section-tabs .left .tabs').on('click', 'a:not(.active)', function (e) {
    ...
    $(this).addClass('active').siblings().removeClass('active').closest('.section-tabs .content').find('.section-tabs .wrapper').removeClass('active').eq($(this).index()).addClass('active');
  });
});
